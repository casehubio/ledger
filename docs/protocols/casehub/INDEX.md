...
| [mcp-domain-hierarchical-naming.md](mcp-domain-hierarchical-naming.md) | @McpDomain values use `/` for hierarchical MCP discovery — never flatten | Any @McpDomain SPI interface across all casehub repos |
